...
import { addEaExamSchema } from "@/src/features/analiz/schemas/add_exam.schema";
  ...
  return (
    <FormProvider {...form}>
      ...
      >
        ...
        <GeneralExamInfoCard exam={"AYT_EA"} />
        <PerformanceAnalysisCard exam={"AYT_EA"} isLoading={isLoading} />
      </form>
    </FormProvider>
  );
}
